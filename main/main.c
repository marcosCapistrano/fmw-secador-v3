...
QueueHandle_t state_manager_q;
QueueHandle_t ihm_update_q;
QueueHandle_t perif_update_q;
QueueHandle_t server_update_q;
...
void app_main(void)
{
    ...
    state_manager_q = xQueueCreate(10, sizeof(StateMessage_t));
    ihm_update_q = xQueueCreate(IHM_UPDATE_QUEUE_LEN, sizeof(IHMUpdate_t));
    perif_update_q = xQueueCreate(10, sizeof(PerifUpdate_t));
    // server_update_q = xQueueCreate(10, sizeof(ServerUpdate_t));
